  ...
  return (
    <nav className="fixed top-0 w-full flex justify-between items-center px-8 py-4 bg-[#32343f]/60 backdrop-blur-lg border-b border-[#3a494a]/20 z-50 shadow-[0_0_40px_rgba(0,245,255,0.08)]">
      ...
      <div className="hidden md:flex items-center gap-8">
        <a className="text-[#e9feff]/70 hover:text-[#e9feff] transition-colors font-display text-sm tracking-tight" href="/dashboard">
          Dashboard
        </a>
        <a className="text-[#e9feff]/70 hover:text-[#e9feff] transition-colors font-display text-sm tracking-tight" href="#">
          Mars Gallery
        </a>
        <a className="text-[#e9feff]/70 hover:text-[#e9feff] transition-colors font-display text-sm tracking-tight" href="#">
          Asteroid Tracker
        </a>
        <a className="text-[#e9feff]/70 hover:text-[#e9feff] transition-colors font-display text-sm tracking-tight" href="/favorites">
          Favorites
        </a>
      </div>
