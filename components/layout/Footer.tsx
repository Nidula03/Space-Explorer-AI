    ...
    <footer className="w-full py-12 px-8 bg-[#0c0e18] border-t border-[#3a494a]/15">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col items-center md:items-start gap-2">
          <span className="text-[#e9feff] font-bold text-lg font-display tracking-tight">StellarAI 🪐</span>
          <p className="font-['Inter'] text-[10px] uppercase tracking-widest text-[#e9feff]/40">© 2026 StellarAI. Powered by Orbital Intelligence.</p>
        </div>
